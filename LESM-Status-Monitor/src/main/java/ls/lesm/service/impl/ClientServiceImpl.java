...
public class ClientServiceImpl implements ClientService {
	...
	public EmployeeAtClientRequest addClientDetailsToEmployee(EmployeeAtClientRequest req, Principal principal) {
        ...
        Optional<EmployeesAtClientsDetails> employeeClientD=this.employeesAtClientsDetailsRepository.findByPONumberIgnoreCase(req.getPONumber());
		
		if(employeeClientD.isPresent() ) {
		
			throw new SupervisorAlreadyExistException("This PO Number Already Assigned To "
		+employeeClientD.get().getMasterEmployeeDetails().getFirstName()
		+" "+employeeClientD.get().getMasterEmployeeDetails().getLastName()
		+" ("+employeeClientD.get().getMasterEmployeeDetails().getLancesoft()+") for "+employeeClientD.get().getClients().getClientsNames());
	...
	public void editClientDetailsForEmployee(Integer clientDetailId, EmployeeAtClientRequest req,
        ...
        if(poNumberDetals.isPresent()) {
       	 if(!clientDetail.getEmpAtClientId().equals(poNumberDetals.get().getEmpAtClientId()))
				throw new SupervisorAlreadyExistException("This PO Number Already Assigned To "
